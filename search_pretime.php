...
<html lang="ja">
  ...
  <body>
    ...
    <div class='hmenu'>
       <!-- ここから検索フォーム -->
      <form class="searchPanel" action='search_pretime.php' method='get'>
        <h2> 検索条件を指定してください</h2>
        <div class="wrapper">
            <div class="data" >
              <dt>
      ...
      ?>
            <tr id="record">
              ...
              <td><?php echo htmlspecialchars($row['open_price']); ?> </td>
              <td><?php echo htmlspecialchars($row['high_price']); ?> </td>	
              <td><?php echo htmlspecialchars($row['low_price']); ?> </td>
              <td><?php echo htmlspecialchars($row['closing_price']); ?> </td>
              <td><?php echo htmlspecialchars($row['avg_price']); ?> </td>
              <td><?php echo htmlspecialchars($row['total_execution']); ?> </td>
              <td><?php echo htmlspecialchars($row['execution_count']); ?> </td>
            </tr>
      <?php
            if($_GET['selecteddate']===$row['trade_date']){
              $trade_totals[] = $row['trade_total'];
            }
            $syprice[] = $row['system_price'];
          }
      ...
      <?php
        ...
        $php_json5 = json_encode($_GET['selecteddate']);
        $php_json6 = json_encode($trade_totals);
        $php_json7 = json_encode($syprice);
